...
function findOptFuelRods()
   ...
   local tempRodLevels = math.floor((2000*numTurbines)/tempMB)
   print(2000*numTurbines.."/"..tempMB.." = "..tempRodLevels)
   ...
   while tempMB > 2000*numTurbines do
      ...
      for i = 1,5 do
       ...
       fuelRodLevel()
       m.setCursorPos(3,6)
       m.write("Getting below "..2000*numTurbines.."mb/t")
       m.setCursorPos(3,7)
   ...
   while tempMB < 2000 do
      ...
      for i = 1,5 do
       ...
       fuelRodLevel()
       m.setCursorPos(3,6)
       m.write("Getting Above "..2000*numTurbines.."mb/t")
       m.setCursorPos(3,7)
       m.write("Currently at: "..tempMB)
       sleep(1)
      end
